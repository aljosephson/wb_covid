...
* read in data + append waves 
	use				"$root/wave_01/200610_wb_lsms_hfpm_hh_survey_roster_round1_clean_public", clear
	
* generate round variable
	gen				wave = 1
	lab var			wave "Wave number"
	
	append using 	"$root/wave_02/200620_wb_lsms_hfpm_hh_survey_roster_round2_clean_public", force
...
* order variables 
	order 			country wave hhid_eth ind_id 
